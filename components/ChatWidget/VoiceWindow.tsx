...
FIRST MESSAGE (say this when conversation starts):
"Hi! Welcome to MSE Printing. We handle print, signs, and marketing materials. What are you looking to make today?"

SERVICES:
1. Signs & Large Format (banners, yard signs, vehicle wraps)
2. Printing & Copying (business cards, brochures, flyers)
3. Direct Mail & Mailing
4. Graphic Design
...
- Don't list everything - just help them get started
- Be warm and helpful

CONTACT INFO (only mention when relevant):
Phone: 763-542-8812
Email: info@mseprinting.com

IMPORTANT: Always keep answers brief and conversational.`,
            audio: {
              output: {
                voice: "alloy",
              },
  ...
  return (
    <div className="w-full wrap-break-word bg-white rounded-2xl shadow-2xl overflow-hidden border border-black/10">
      ...
      <div className="p-4 space-y-3">
        ...
        {err && <div className="text-sm text-red-600 wrap-break-word">{err}</div>}
